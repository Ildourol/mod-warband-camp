...
PropDef const g_propCatalogue[] =
    {
        ...
        { "tent-orc", 193217, "Orc Scout Tent", 5.5f },
        ...
        { "tent-shattrath", 183355, "Shattrath Pavilion Tent", 8.0f },
        { "tent-shadow", 185001, "Shadow Council Tent", 6.5f },
        { "tent-goblin", 188179, "Goblin Striped Tent", 6.5f },
        { "tent-forsaken-large", 190217, "Forsaken Pavilion Tent", 7.5f },
        { "tent-shadow-large", 185002, "Shadow Council Pavilion", 8.0f },
        { "tent-wotlk-light", 190794, "Argent Light Tent", 7.0f },
        { "tent-orc-war", 193218, "Orc War Camp Tent", 7.0f },
        { "tent-nelf", 201388, "Night Elven Pavilion", 7.5f },
        ...
        { "brazier-ogre", 176093, "Purple Ogre Brazier", 2.5f },
        { "brazier-legion", 184613, "Legion Brazier", 2.5f },
        { "bowl-fire", 182078, "Elven Fire Bowl", 3.0f },
        { "fire-soul", 16394, "Green Soulfire", 3.0f },
        { "fire-soul-large", 16395, "Large Soulfire Pit", 3.5f },
        { "brazier-brewfest", 195260, "Brewfest Fire Basin", 2.5f },
        { "brazier-midsummer", 181388, "Grand Midsummer Brazier", 3.0f },
        // furniture
        ...
        { "chair-westfall", 180047, "Rustic Wood Chair", 2.0f },
        { "table-party", 180698, "Small Tavern Table", 2.5f },
        { "table-dwarf-small", 180884, "Small Dwarven Table", 2.5f },
        { "table-duskwood", 183994, "Carved Oak Table", 3.0f },
        { "rug-bearskin", 19405, "Bearskin Rug", 3.0f },
        { "table-round", 184657, "Round Ironridge Table", 3.0f },
        { "table-bloodelf", 182093, "Blood Elf Table", 2.5f },
        // storage & amenities
        ...
        { "powderkeg", 1670, "Dwarven Powder Keg", 2.0f },
        { "crate-replace", 184854, "Reinforced Cargo Crate", 2.5f },
        { "crate-brewfest", 195265, "Brewfest Crate", 2.5f },
        { "chest-treasure", 144111, "Treasure Chest", 2.5f },
        // yard
        ...
        { "rowboat", 190230, "Wooden Rowboat", 4.5f },
        { "haypile-large", 19419, "Vrykul Straw Pile", 3.5f },
        { "target-human", 13952, "Straw Archery Target", 2.5f },
        { "cannonball-stack", 180054, "Iron Cannonball Stack", 2.0f },
        // craft
        ...
        { "armorstand", 188216, "Armor Display Stand", 2.5f },
        { "armorstand-mail", 188218, "Mail Armor Mannequin", 2.5f },
        { "steamtank", 180605, "Gnomish Steam Tank", 6.0f },
        // defenses & fortifications
        { "barricade-wood", 193613, "Reinforced Wooden Barricade", 4.0f },
        { "barricade-spikes", 193614, "Spiked Defensive Barricade", 4.0f },
        { "siege-catapult", 180744, "Horde Catapult", 7.0f },
        { "siege-cannon", 190228, "Ironclad Field Cannon", 4.0f },
        { "gate-portcullis", 187912, "Cemetery Portcullis Gate", 5.0f },
        ...
        { "banner-argent", 191614, "Argent Crusade Standing Banner", 2.5f },
        { "banner-maghar", 182259, "Mag'har Clan Battle Standard", 2.5f },
        { "banner-ogre-boar", 185596, "Bladespire Clan Standard", 2.5f },
        { "banner-ogre-tiger", 185597, "Bloodmaul Clan Standard", 2.5f },
        { "banner-warrior", 25336, "Warrior Crest Banner", 2.5f },
        // lights
        ...
        { "candle-val", 181060, "Decorated Festive Candle", 2.0f },
        { "lantern-vrykul", 193566, "Vrykul Carved Lantern Post", 2.5f },
        // food & provisions
        ...
        { "turkey-leg", 1587, "Roast Turkey Leg", 2.0f },
        ...
        { "meat-haunch", 2332, "Roast Game Haunch", 2.0f },
        { "bread-baked", 2562, "Oven Baked Hearth Bread", 2.0f },
        { "bottle-orc", 33360, "Orcish Flagon Bottle", 2.0f },
        // trophies & the hunt
        { "carcass-fresh", 188429, "Hanging Hunt Carcass", 2.5f },
        { "trophy-ogre-head", 185294, "Mounted Ogre Trophy Head", 2.5f },
        { "fur-quality", 187983, "High Quality Fur Hide", 2.5f },
        { "meat-wagon-grill", 193617, "Smoker & Roasting Grill", 3.0f },
        { "cage-bear", 194120, "Reinforced Beast Cage", 4.0f },
        { "trophy-horn", 147136, "Great Reaver Trophy Horn", 2.5f },
        { "leather-stand", 188221, "Tanned Leather Display", 2.5f },
        // graveyard & dark arts
        { "coffin-musty", 190948, "Musty Coffin", 3.0f },
        { "skeleton-hanging", 180410, "Hanging Crypt Skeleton", 3.0f },
        { "gravestone-moss", 192256, "Mossy Gravestone", 2.5f },
        { "skull-candle", 180425, "Ritual Skull Candle", 2.0f },
        { "skull-hanging", 180471, "Hanging Skull Lantern", 2.5f },
        { "skull-voodoo", 190214, "Voodoo Skull Pile", 2.5f },
        { "bones-frozen", 193961, "Frozen Scourge Remains", 3.0f },
        { "bones-pile", 177604, "Bone Pile", 2.5f },
        { "bones-blasted", 180225, "Ancient Blasted Bone Pile", 3.0f },
        { "skull-lamp-tall", 180472, "Hanging Crypt Skull Lamp", 2.5f },
        // treasures & curios
        { "gold-sack", 180660, "Sack of Gold", 2.0f },
        { "gem-heart", 185125, "Heart of Fury Precious Gem", 2.5f },
        { "goblet-golden", 192946, "Ornate Golden Goblet", 1.5f },
        { "orb-magic-blue", 190019, "Nexus Arcane Orb", 2.5f },
        { "orb-invention", 193589, "Gnomish Invention Orb", 2.5f },
        { "orb-apothecary", 190675, "Apothecary Glowing Orb", 2.5f },
        { "incense-burner", 186559, "Ornate Incense Burner", 2.5f },
        { "crystal-moon", 181361, "Night Elf Moon Crystal", 2.5f },
        { "crystal-sholazar", 190503, "Sholazar Crystal Geode", 2.5f },
        { "statuette-ancient", 18603, "Ancient Relic Figurine", 2.0f },
        { "orb-dragon", 189305, "Dragon Crystalline Orb", 2.5f },
        { "crystal-crimson", 184450, "Crimson Crystal Shard", 3.0f },
        // atmosphere
        ...
        { "crystal-yellow", 164927, "Glowing Yellow Crystal", 2.5f },
        { "weather-vane", 177746, "Goblin Weather Vane", 2.5f },
        // nature
        ...
        { "plant-bogbean", 20939, "Swamp Lily Plant", 2.0f },
        { "bush-barrens", 48516, "Barrens Shrub", 2.5f },
        { "tree-xmas-large", 187190, "Festive Conifer Tree", 5.0f },
        ...
        { "table-scribe", 174681, "Scribe Drafting Table", 3.0f },
        ...
        { "pavilion-food", 180031, "Festival Food Canopy", 7.0f },
        ...
        { "pavilion-royal", 181244, "Grand Royal Pavilion", 9.0f },
        // portals
        ...
        { "npc-stablemaster", 9896, "Stable Master (Pet Care)", 2.5f, true },
        { "npc-poisons", 29535, "Poison & Alchemy Specialist", 2.5f, true },
        { "npc-guard-sw", 68, "Stormwind Camp Guard", 2.5f, true },
        { "npc-guard-org", 3296, "Orgrimmar Camp Guard", 2.5f, true },
